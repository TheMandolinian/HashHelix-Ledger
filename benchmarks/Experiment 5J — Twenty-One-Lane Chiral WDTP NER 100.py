...
fig.text(
    0.5,
    0.89,
    "21 independent lanes with a₁ = 1..21, spaced from x = −10..+10. All lanes computed, no mirroring.",
    ha="center",
    fontsize=10,
    color="white",
)
...
fig.savefig(
    "spiral_ner_21lane_100.png",
    bbox_inches="tight",
    pad_inches=0.2,
    facecolor="black",
)

print("Saved spiral_ner_21lane_100.png")
